...
namespace Betfair
{
    public class RescriptClient : HttpWebClientProtocol, IClient
    {
        ...
        private string EndPoint = "https://api.betfair.com/exchange/betting" + "/rest/v1/";
        ...
        private static readonly string LIST_COMPETITIONS = "listCompetitions";
        private static readonly string LIST_TIME_RANGES = "listTimeRanges";
        private static readonly string LIST_EVENTS = "listEvents";
        private static readonly string LIST_MARKET_TYPES_METHOD = "listMarketTypes";
        private static readonly string LIST_COUNTRIES = "listCountries";
        private static readonly string LIST_VENUES = "listVenues";
        ...
        private static readonly string LIST_RUNNER_BOOK = "listRunnerBook";
        ...
        public T Invoke<T>(string method, IDictionary<string, object> args = null)
        {
            ...
            using ( StreamReader reader = new StreamReader(stream, Encoding.UTF8) )
            {
                ...
                {
                    throw ReconstituteException(JsonConvert.Deserialize<Betfair.Models.Exception>(jsonResponse));
                }
        ...
        private static System.Exception ReconstituteException(Betfair.Models.Exception ex)
        {
            var data = ex.Detail;
        ...
        /// <summary>
        /// Отправка запроссов с помощью RescriptClient
        /// </summary>
        /// <param name="appKey">Ключ пользователя</param>
        /// <param name="sessionToken">Сессия ключ</param>
        public RescriptClient(TypeApi typeApi, string appKey, string sessionToken)
		{
            ...
            switch ( typeApi )
            {
                case TypeApi.Account: EndPoint = "https://api.betfair.com/exchange/account" + "/rest/v1.0/"; break;
                case TypeApi.Betting: EndPoint = "https://api.betfair.com/exchange/betting" + "/rest/v1.0/"; break;
            }
        }
        ...
        /// <param name="locale">Язык, используемый для ответа. Если не указан, возвращается значение по умолчанию.</param>
        /// <returns></returns>
        public IList<MarketCatalogue> listMarketCatalogue(MarketFilter marketFilter, ISet<MarketProjection> marketProjections, MarketSort? marketSort =null, string maxResult = "1", string locale = null)
        {
            var args = new Dictionary<string, object>();
            args[Parametrs.FILTER] = marketFilter;
